...
```{r compare-results, echo = FALSE, fig.width=6, fig.height=3, out.width="800px", dpi=600}
kable(test.results)
plot(test.results, theme_size=8)
```
...
```{r performance-speed-up, echo = FALSE, fig.width=6, fig.height=3, out.width="800px", dpi=600}
kable(urbanekPerformance(test.results), digits = 2)
plot(urbanekPerformance(test.results), theme_size=10, main = "Relative Performance")
```
